...
{
    private Dictionary<int, Toggle> answerToggles = new Dictionary<int, Toggle>();//答案组件
    ...
    public override void Open(UIData uiData = null)
    {
        ...
        if (exercisePedia == null || exercisePedia.data == null)
        {
            ...
            UIManager.Instance.OpenUI<PopupPanel>(UILevel.PopUp, new UIPopupData("提示", "获取习题失败，请重试", popupDic));
        }
        else
        {
