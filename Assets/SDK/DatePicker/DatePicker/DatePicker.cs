...
#pragma warning restore
        ...
        [SerializeField]
        private TMPro.TMP_InputField m_Ref_TMPInputField;
        public TMPro.TMP_InputField Ref_TMPInputField
        {
            get
            {
                if (m_Ref_TMPInputField == null && Ref_OldInputField != null)
                {
                    m_Ref_TMPInputField = DatePicker_TextMeshProUtilities.ReplaceInputFieldWithTextMeshPro(Ref_OldInputField);
                }

                return m_Ref_TMPInputField;
            }
            set
            {
                m_Ref_TMPInputField = value;
            }
        }
        ...
        public InputField Ref_InputField
        {
            get
            {
                ...
                {
                    m_Ref_InputField = Ref_OldInputField = GetComponentInChildren<InputField>();
                }
        ...
        void UpdateHeader()
        {
            ...
            else
            {
                ...
                Ref_Header.PreviousMonthButton.Button.interactable = lastDayOfPreviousMonth > DateTime.Now;

                var lastDayOfMonthInPreviousYear = VisibleDate.Date.AddYears(-1);
                lastDayOfMonthInPreviousYear = new DateTime(lastDayOfMonthInPreviousYear.Year, lastDayOfMonthInPreviousYear.Month, DateTime.DaysInMonth(lastDayOfMonthInPreviousYear.Year, lastDayOfMonthInPreviousYear.Month));

                Ref_Header.PreviousYearButton.Button.interactable = lastDayOfMonthInPreviousYear > DateTime.Now;
            }
        ...
        public UnityAction<DateTime> OnSingleDayButtonClicked;
        ...
        public void DayButtonClicked(DateTime date)
        {
            if (DateSelectionMode == Dates.DateSelectionMode.SingleDate)
            {
                ...
                OnSingleDayButtonClicked?.Invoke(SelectedDate);
            }
            else
            {
