...
namespace UI.Dates
{
    public static class DatePickerUtilities
    {
        ...
        public static string[] GetAbbreviatedDayNames()
        {
            ...
            return Shift(DateTimeFormatInfo.CurrentInfo.AbbreviatedDayNames.Where(d => d != "").Select(d => d.Replace("÷‹", "")).ToArray(), (int)DateTimeFormatInfo.CurrentInfo.FirstDayOfWeek);
        }
