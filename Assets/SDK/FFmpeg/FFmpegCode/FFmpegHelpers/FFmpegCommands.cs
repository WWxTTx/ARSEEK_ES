...
public static class FFmpegCommands
{
    ...
    public static void AppendFast(AppendData config)
	{
        ...
        //cmdList.Add(FILE_FORMAT_INPUT_INSTRUCTION);
        //cmdList.Add(CONCAT_INSTRUCTION);
        //cmdList.Add(SAFE_INSTRUCTION);
        //cmdList.Add(ZERO_INSTRUCTION);
        //cmdList.Add(INPUT_INSTRUCTION);
        //cmdList.Add(GetInputsFile(config.inputPaths));
        //cmdList.Add(C_CODEC_INSTRUCTION);
        //cmdList.Add(COPY_INSTRUCTION);
        //cmdList.Add(config.outputPath);
        //cmdList.Add(REWRITE_INSTRUCTION);

        //-f concat -safe 0 -i .../mylist.txt -c copy .../output.mp4 -y
        string[] command = /*cmdList.ToArray();*/
        {
            ...
            ZERO_INSTRUCTION,
            INPUT_INSTRUCTION,
            GetInputsFile(config.inputPaths, config.appendFile),
            C_CODEC_INSTRUCTION,
            COPY_INSTRUCTION,
            config.outputPath,
            REWRITE_INSTRUCTION
    ...
    static string GetInputsFile(List<string> inputPaths, string appendFile)
	{
		...
		string filePath = Path.Combine(inputFolder, appendFile/*"AppendInputFiles.txt"*/);
