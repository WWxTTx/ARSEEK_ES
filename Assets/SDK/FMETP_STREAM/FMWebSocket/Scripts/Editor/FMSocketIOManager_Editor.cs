...
public class FMSocketIOManager_Editor : Editor
{
    ...
    SerializedProperty Settings_URLProp;
    ...
    void OnEnable()
    {
        ...
        Settings_URLProp = serializedObject.FindProperty("Settings.URL");
            ...
            GUILayout.BeginVertical("box");
            {
                GUILayout.BeginVertical();
                {
                    if (ShowSettings)
                    {
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.PropertyField(Settings_URLProp, new GUIContent("URL"));
                            GUILayout.EndHorizontal();
