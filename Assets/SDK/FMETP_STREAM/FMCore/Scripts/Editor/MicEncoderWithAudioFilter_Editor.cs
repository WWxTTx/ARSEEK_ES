...
[CustomEditor(typeof(MicEncoderWithAudioFilter))]
[CanEditMultipleObjects]
public class MicEncoderWithAudioFilter_Editor : Editor
{
    private MicEncoderWithAudioFilter MEncoder;
    ...
    {
        if (MEncoder == null) MEncoder = (MicEncoderWithAudioFilter)target;
