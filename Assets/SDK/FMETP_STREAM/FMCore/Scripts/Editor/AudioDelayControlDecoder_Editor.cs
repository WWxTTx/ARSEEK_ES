...
[CustomEditor(typeof(AudioDelayControlDecoder))]
[CanEditMultipleObjects]
public class AudioDelayControlDecoder_Editor : Editor
{
    private AudioDelayControlDecoder ADecoder;
    ...
    {
        if(ADecoder== null) ADecoder = (AudioDelayControlDecoder)target;
        ...
        GUILayout.BeginVertical("box");
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                GUILayout.EndHorizontal();
                GUILayout.BeginHorizontal();
                GUILayout.Label("Source Stream FPS: " + ADecoder.SourceStreamFPS);
                GUILayout.EndHorizontal();
                GUILayout.BeginHorizontal();
                GUILayout.Label("Source Frame Duration Ms: " + ADecoder.SourceFrameDuration);
                GUILayout.EndHorizontal();
                GUILayout.BeginHorizontal();
