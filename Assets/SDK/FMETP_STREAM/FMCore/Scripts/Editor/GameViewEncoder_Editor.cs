...
public class GameViewEncoder_Editor : Editor
{
    ...
    SerializedProperty RectOffsetPositionProp;
    ...
    void OnEnable()
    {
        ...
        RectOffsetPositionProp = serializedObject.FindProperty("RectOffsetPosition");
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.BeginVertical("box");
        {
            ...
            else if (GVEncoder.CaptureMode == GameViewCaptureMode.FullScreen || GVEncoder.CaptureMode == GameViewCaptureMode.Rect)
            {
                GUILayout.BeginVertical("box");
                {
                    GUIStyle style = new GUIStyle();
        ...
        GUILayout.BeginVertical("box");
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                if (GVEncoder.CaptureMode == GameViewCaptureMode.Rect)
                {
                    GUILayout.BeginHorizontal();
                    EditorGUILayout.PropertyField(RectOffsetPositionProp, new GUIContent("Rect Offset Position"));
                    GUILayout.EndHorizontal();
                }

                if (GVEncoder.CaptureMode == GameViewCaptureMode.FullScreen || GVEncoder.CaptureMode == GameViewCaptureMode.Rect)
                {
                    GUILayout.BeginHorizontal();
                    EditorGUILayout.PropertyField(ResizeProp, new GUIContent("Resize"));
                    GUILayout.EndHorizontal();
